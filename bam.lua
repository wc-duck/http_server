...
local lib   = StaticLibrary( settings, 'http_server', objs )

local fileserv = Link( settings, 'simple_file_server', Compile( settings, 'test/simple_file_server.cpp' ), lib )
local restapi  = Link( settings, 'simple_rest_api',    Compile( settings, 'test/simple_rest_api.cpp' ), lib )
